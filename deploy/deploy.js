const governance = "0xD92c7fAa0Ca0e6AE4918f3a83d9832d9CAEAA0d3";
const strategist = "0x1CbF903De5D688eDa7D6D895ea2F0a8F2A521E99";
...
const want = "0x9461173740D27311b176476FA27e94C681b1Ea6b";

module.exports = async ({ getNamedAccounts, deployments }) => {
  const { deploy, execute } = deployments;
  const { deployer } = await getNamedAccounts();

  await deploy("StrategySushiEthYvBoostLp", {
    from: deployer,
