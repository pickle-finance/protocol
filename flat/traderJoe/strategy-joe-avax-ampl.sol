...
// File contracts/strategies/traderJoe/strategy-joe-avax-ampl.sol
...
contract StrategyJoeAvaxAmplLp is StrategyJoeRushFarmBase {
    ...
    function harvest() public override onlyBenevolent {
        ...
        if (_joe > 0) {
            ...
            _swapTraderJoe(joe, ampl, _amount);
        }
        ...
        //convert Avax Rewards
            ...
            _swapTraderJoe(wavax, ampl, _amount2);
        }
        ...
        if (_wavax > 0 && _ampl > 0) {
            ...
            IERC20(ampl).safeTransfer(
                IController(controller).treasury(),
                IERC20(ampl).balanceOf(address(this))
            );
        }
