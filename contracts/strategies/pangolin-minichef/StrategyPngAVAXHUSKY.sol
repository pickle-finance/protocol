...
contract StrategyPngAVAXHUSKYMiniLp is StrategyPngMiniChefFarmBase {
    uint256 public _poolId = 26;

    // Token addresses
    address public Png_AVAX_HUSKY_lp = 0xd05e435Ae8D33faE82E8A9E79b28aaFFb54c1751;
    address public token1 = 0x65378b697853568dA9ff8EaB60C13E1Ee9f4a654;
  ...
  function harvest() public override onlyBenevolent {
    ...
    function getName() external pure override returns (string memory) {
        return "StrategyPngAVAXHUSKYMiniLp";
    }
}