...
contract StrategyPngAVAXUSDCeMiniLp is StrategyPngMiniChefFarmBase {
    uint256 public _poolId = 9;

    // Token addresses
    address public Png_AVAX_USDCe_lp = 0xbd918Ed441767fe7924e99F6a0E0B568ac1970D9;
    address public token1 = 0xA7D7079b0FEaD91F3e65f86E8915Cb59c1a4C664;
  ...
  function harvest() public override onlyBenevolent {
    ...
    function getName() external pure override returns (string memory) {
        return "StrategyPngAVAXUSDCeMiniLp";
    }
}