...
contract StrategyPngSkillUsdteLp is StrategyPngMiniChefFarmBase {
    uint256 public _poolId = 50;

    // Token addresses
    address public Png_SKILL_USDTE_lp = 0xF52B3Df311182F43202806ee0E72aCB92d777879;
  ...
  function harvest() public override onlyBenevolent {
    ...
    function getName() external pure override returns (string memory) {
        return "StrategyPngSkillUsdteLp";
    }
}