...
contract StrategyPngAVAXJOEMiniLp is StrategyPngMiniChefFarmBase {
    uint256 public _poolId = 14;

    // Token addresses
    address public Png_AVAX_JOE_lp = 0x134Ad631337E8Bf7E01bA641fB650070a2e0efa8;
    address public token1 = 0x6e84a6216eA6dACC71eE8E6b0a5B7322EEbC0fDd;
  ...
  function harvest() public override onlyBenevolent {
    ...
    function getName() external pure override returns (string memory) {
        return "StrategyPngAVAXJOEMiniLp";
    }
}