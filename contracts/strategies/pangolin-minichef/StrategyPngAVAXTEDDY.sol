...
contract StrategyPngAVAXTEDDYMiniLp is StrategyPngMiniChefFarmBase {
    uint256 public _poolId = 27;

    // Token addresses
    address public Png_AVAX_TEDDY_lp = 0x4F20E367B10674cB45Eb7ede68c33B702E1Be655;
    address public token1 = 0x094bd7B2D99711A1486FB94d4395801C6d0fdDcC;
  ...
  function harvest() public override onlyBenevolent {
    ...
    function getName() external pure override returns (string memory) {
        return "StrategyPngAVAXTEDDYMiniLp";
    }
}