...
contract StrategyJoeAvaxCraftLp is StrategyJoeRushFarmBase {
    ...
    uint256 public avax_craft_poolId = 19;
    ...
    {}
     ...
     function _takeFeeCraftToSnob(uint256 _keep) internal {
        ...
        IERC20(craft).safeApprove(pangolinRouter, _keep);
        _swapPangolin(craft, snob, _keep);
    ...
    function harvest() public override onlyBenevolent {
        ...
        if (_wavax > 0) {
         ...
         if (_craft > 0) {
            ...
            _craft = IERC20(wavax).balanceOf(address(this));
