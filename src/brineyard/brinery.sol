...
// File contracts/MagicPickleMoney.sol
// License-Identifier: MIT
...
contract MagicPickleMoney is ERC20, BoringOwnable {
    using BoringMath for uint256;
    // ERC20 'variables'
    string public constant symbol = "MPM";
    string public constant name = "Magic Pickle Money";
    ...
    function mint(address to, uint256 amount) public onlyOwner {
        require(to != address(0), "MPM: no mint to zero address");
    ...
    function burn(uint256 amount) public {
        require(amount <= balanceOf[msg.sender], "MPM: not enough");
...
// $$ |  $$ $$ |     $$ $$ |  $$ $$   ____$$ |     $$ |  $$ |
// $$$$$$$  $$ |     $$ $$ |  $$ \$$$$$$$\$$ |     \$$$$$$$ |
// \_______/\__|     \__\__|  \__|\_______\__|      \____$$ |
//                                                 $$\   $$ |
//                                                 \$$$$$$  |
//                                                  \______/
...
/// @dev This contract allows contract calls to any contract (except BentoBox)
/// from arbitrary callers thus, don't trust calls from this contract in any circumstances.
contract BrineryV2Flat is BoringOwnable, IMasterContract {
    using BoringMath for uint256;
    using BoringMath128 for uint128;
    ...
    BrineryV2Flat public immutable masterContract;
    IERC20 public immutable magicPickleMoney;
    ...
    constructor(IBentoBoxV1 bentoBox_, IERC20 magicPickleMoney_) public {
        bentoBox = bentoBox_;
        magicPickleMoney = magicPickleMoney_;
        masterContract = this;
    }
    ...
    function init(bytes calldata data) public payable override {
        ...
        require(address(collateral) != address(0), "Brinery: bad pair");
    }
        ...
        returns (uint256 part, uint256 share)
    {
        ...
        share = bentoBox.toShare(magicPickleMoney, amount, false);
        bentoBox.transfer(magicPickleMoney, address(this), to, share);
    ...
    function _repay(
        ...
        uint256 share = bentoBox.toShare(magicPickleMoney, amount, true);
        bentoBox.transfer(
            magicPickleMoney,
    ...
    function _call(
        ...
        require(success, "Brinery: call failed");
    ...
    function liquidate(
        ...
        require(allBorrowAmount != 0, "Brinery: all are solvent");
        ...
        // Apply a percentual fee share to DILL holders
    ...
    function withdrawFees() public {
        ...
        uint256 share = bentoBox.toShare(magicPickleMoney, _feesEarned, false);
        bentoBox.transfer(magicPickleMoney, address(this), _feeTo, share);
    ...
    /// @notice reduces the supply of MPM
    ...
    function reduceSupply(uint256 amount) public {
        ...
        MagicPickleMoney(address(magicPickleMoney)).burn(amount);
    }
}
