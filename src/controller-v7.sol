...
import "./interfaces/strategyv3.sol";
...
contract ControllerV7 {
    ...
    function setStrategy(address _pool, address _strategy) public {
        ...
        if (_current != address(0)) {
            IStrategyV3(_current).withdrawAll();
        }
    ...
    function earn(
        ...
        address _want = IStrategyV3(_strategy).pool();
