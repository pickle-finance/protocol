...
import "../../../strategies/cronos/tectonic/strategy-tectonic-dai.sol";

contract StrategyTectonicDai is DSTestDefiBase {
    StrategyTectonicDai strategy;
    ...
    function setUp() public {
        ...
        strategy = new StrategyTectonicDai(
            governance,
            strategist,
            address(controller),
            timelock
