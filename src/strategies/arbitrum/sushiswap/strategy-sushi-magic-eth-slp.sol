...
contract StrategyArbSushiMagicEthSlp is StrategySushiArbBase {
    address private constant _lp = 0xB7E50106A5bd3Cf21AF210A755F9C8740890A8c9;
    uint256 private constant _pid = 13;
    ...
    function getName() external pure override returns (string memory) {
        return "StrategyArbSushiMagicEthSlp";
    }
}
