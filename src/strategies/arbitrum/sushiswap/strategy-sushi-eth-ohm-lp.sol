...
contract StrategySushiEthGohmLp is StrategySushiFarmBase {
    // Token/ETH pool id in MasterChef contract
    uint256 public sushi_eth_gohm_poolId = 12;
    // Token addresses
    address public sushi_eth_gohm_lp =
