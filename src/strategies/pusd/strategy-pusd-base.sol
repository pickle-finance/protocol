...
abstract contract StrategyPusdBase {
    ...
    address public curveRouter = 0xbEbc44782C7dB0a1A60Cb6fe97d0b483032FF1C7;
    ...
    function _wantToUnderlying() internal virtual returns (uint256);

    function _underlyingToWant() internal virtual returns (uint256);
