...
contract StrategyConvexCompCRV is StrategyConvexFarmBase {
    address public comp_pool = 0xA2B47E3D5c44877cca798226B7B8118F9BFb7A56;
    uint256 public cvx_pool_id = 0;
    address public lpToken = 0x845838DF265Dcd2c412A1Dc9e959c7d08537f8a2;
        ...
        returns (address, uint256)
    {
        ...
        balances[0] = ICurveFi_2(curve).balances(0); // DAI
        balances[1] = ICurveFi_2(curve).balances(1).mul(10**12); // USDC
