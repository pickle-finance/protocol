...
contract StrategyOpSushiUsdcSusdSslp is StrategySushiOpBase {
    address private constant _lp = 0x9Ed1f0Cc0077b5dF99c6aD98B4dccf65f6D8BD04;
    uint256 private constant _pid = 2;
    ...
    constructor(
        ...
        _p1[0] = ITridentRouter.Path({
            pool: 0x7086622E6Db990385B102D79CB1218947fb549a9,
            data: abi.encode(native, 0x9Ed1f0Cc0077b5dF99c6aD98B4dccf65f6D8BD04, false)
        });
        _p1[1] = ITridentRouter.Path({
            pool: 0x9Ed1f0Cc0077b5dF99c6aD98B4dccf65f6D8BD04,
    ...
    function getName() external pure override returns (string memory) {
        return "StrategyOpSushiUsdcSusdSslp";
    }
}
