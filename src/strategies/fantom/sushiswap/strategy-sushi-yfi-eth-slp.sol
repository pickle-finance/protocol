...
contract StrategyFantomSushiYfiEthSlp is StrategySushiFantomBase {
    // Addresses
    address private constant _lp = 0xe3eD4237532E6095749a6C984bFCb449C2b86122;
    uint256 private constant _poolId = 9;
    ...
    function getName() external pure override returns (string memory) {
        return "StrategyFantomSushiYfiEthSlp";
    }
}
