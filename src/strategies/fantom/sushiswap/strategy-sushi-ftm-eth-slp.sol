...
contract StrategyFantomSushiFtmEthSlp is StrategySushiFantomBase {
    // Addresses
    address private constant _lp = 0x3d0BD54c48C2C433ea6fed609Cc3d5Fb7A77622B;
    uint256 private constant _poolId = 1;
    ...
    function getName() external pure override returns (string memory) {
        return "StrategyFantomSushiFtmEthSlp";
    }
}
