...
contract StrategyFantomSushiFtmSushiSlp is StrategySushiFantomBase {
    // Addresses
    address private constant _lp = 0x49D2e0DC99C7358D7A9A8633Bf6df111D0EE7F65;
    uint256 private constant _poolId = 6;
    ...
    function getName() external pure override returns (string memory) {
        return "StrategyFantomSushiFtmSushiSlp";
    }
}
