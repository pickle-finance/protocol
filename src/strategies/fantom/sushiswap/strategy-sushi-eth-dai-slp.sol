...
contract StrategyFantomSushiEthDaiSlp is StrategySushiFantomBase {
    // Addresses
    address private constant _lp = 0x71C8BceEcE3dAf9E27741D2Cc1F03170f862555f;
    uint256 private constant _poolId = 3;
    ...
    function getName() external pure override returns (string memory) {
        return "StrategyFantomSushiEthDaiSlp";
    }
}
