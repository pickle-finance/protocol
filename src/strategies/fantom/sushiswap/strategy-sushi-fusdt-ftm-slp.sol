...
contract StrategyFantomSushiFusdtFtmSlp is StrategySushiFantomBase {
    // Addresses
    address private constant _lp = 0xd019dd7C760c6431797d6ed170bFFb8FAee11F99;
    uint256 private constant _poolId = 2;
    ...
    function getName() external pure override returns (string memory) {
        return "StrategyFantomSushiFusdtFtmSlp";
    }
}
