...
contract StrategyFantomSushiCrvEthSlp is StrategySushiFantomBase {
    // Addresses
    address private constant _lp = 0x97A039255ecC352e5782Fc49beA26B03F60FA49b;
    uint256 private constant _poolId = 8;
    ...
    function getName() external pure override returns (string memory) {
        return "StrategyFantomSushiCrvEthSlp";
    }
}
