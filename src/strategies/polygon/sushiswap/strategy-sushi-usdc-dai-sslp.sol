...
contract StrategyPolySushiUsdcDaiSslp is StrategySushiPolyBase {
    address private constant _lp = 0x4440C62021c5a0d6feC1A2143914Be0c5A0A00EA;
    uint256 private constant _pid = 63;
    ...
    constructor(
        ...
        _p1[0] = ITridentRouter.Path({
            pool: 0x846Fea3D94976ef9862040d9FbA9C391Aa75A44B,
            data: abi.encode(native, 0x4440C62021c5a0d6feC1A2143914Be0c5A0A00EA, false)
        });
        _p1[1] = ITridentRouter.Path({
            pool: 0x4440C62021c5a0d6feC1A2143914Be0c5A0A00EA,
    ...
    function getName() external pure override returns (string memory) {
        return "StrategyPolySushiUsdcDaiSslp";
    }
}
